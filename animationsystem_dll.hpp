    ...
    namespace schemas {
        ...
        namespace animationsystem_dll {
            ...
            namespace COrientationWarpUpdateNode {
                constexpr std::ptrdiff_t m_eTarget = 0x6C; // AnimValueSource
                constexpr std::ptrdiff_t m_hTargetParam = 0x70; // CAnimParamHandle
                constexpr std::ptrdiff_t m_hTargetPositionParam = 0x72; // CAnimParamHandle
                constexpr std::ptrdiff_t m_flTargetOffset = 0x74; // float32
                constexpr std::ptrdiff_t m_hTargetOffsetParam = 0x78; // CAnimParamHandle
                constexpr std::ptrdiff_t m_damping = 0x80; // CAnimInputDamping
                constexpr std::ptrdiff_t m_flSmoothDampingDuration = 0x90; // float32
                constexpr std::ptrdiff_t m_bAddRootMotionIfNeeded = 0x94; // bool
                constexpr std::ptrdiff_t m_flMaxRootMotionScale = 0x98; // float32
                constexpr std::ptrdiff_t m_bEnablePreferredRotationDirection = 0x9C; // bool
                constexpr std::ptrdiff_t m_ePreferredRotationDirection = 0xA0; // AnimValueSource
                constexpr std::ptrdiff_t m_flPreferredRotationThreshold = 0xA4; // float32
            }
            // Parent: None
            // Field count: 7
            //
            ...
            namespace CNmGraphDataSet {
                ...
                constexpr std::ptrdiff_t m_warnings = 0x48; // CUtlVector<CUtlString>
            }
            ...
            namespace CNmSkeleton {
                ...
                constexpr std::ptrdiff_t m_serializedMasks = 0x68; // CUtlLeanVector<CNmBoneMask::SerializedData_t>
            }
            // Parent: CMotionMetricEvaluator
            // Field count: 2
            //
            ...
            namespace CRagdollComponentUpdater {
                ...
                constexpr std::ptrdiff_t m_flSpringFrequencyMin = 0xA8; // float32
                constexpr std::ptrdiff_t m_flSpringFrequencyMax = 0xAC; // float32
                constexpr std::ptrdiff_t m_flMaxStretch = 0xB0; // float32
                constexpr std::ptrdiff_t m_bSolidCollisionAtZeroWeight = 0xB4; // bool
            }
            // Parent: None
            // Field count: 9
            //
            ...
            namespace CTargetSelectorUpdateNode {
                ...
                constexpr std::ptrdiff_t m_hTargetPosition = 0x7C; // CAnimParamHandle
                constexpr std::ptrdiff_t m_hTargetFacePositionParameter = 0x7E; // CAnimParamHandle
                constexpr std::ptrdiff_t m_hForwardDirectionOverrideParameter = 0x80; // CAnimParamHandle
                constexpr std::ptrdiff_t m_bTargetPositionIsWorldSpace = 0x82; // bool
                constexpr std::ptrdiff_t m_bTargetFacePositionIsWorldSpace = 0x83; // bool
            }
            // Parent: None
            // Field count: 1
            //
            ...
            // Metadata:
            // MGetKV3ClassDefaults
            namespace MoveSpeedId_t {
                constexpr std::ptrdiff_t m_eMovementGait = 0x0; // MovementGait_t
                constexpr std::ptrdiff_t m_sName = 0x8; // CGlobalSymbol
            }
            // Parent: None
            // Field count: 17
            ...
            namespace CStateMachineUpdateNode {
                ...
                constexpr std::ptrdiff_t m_bResetWhenActivated = 0xF6; // bool
            }
            // Parent: CUnaryUpdateNode
            // Field count: 6
            //
            ...
            // Metadata:
            // MGetKV3ClassDefaults
            namespace CNmBoneMask__SerializedData_t {
                constexpr std::ptrdiff_t m_ID = 0x0; // CGlobalSymbol
                constexpr std::ptrdiff_t m_weights = 0x8; // CUtlVector<float32>
            }
            // Parent: CNmEvent
            ...
            namespace CNmClip {
                ...
                constexpr std::ptrdiff_t m_secondaryAnimations = 0x80; // CUtlVectorFixedGrowable<CNmClip*,1>
            ...
            namespace CPhysSurfacePropertiesPhysics {
                ...
                constexpr std::ptrdiff_t m_burnfuel = 0x24; // float32
            }
            // Parent: CAnimationGraphVisualizerPrimitiveBase
            // Field count: 4
            //
            ...
            namespace CFollowPathUpdateNode {
                ...
                constexpr std::ptrdiff_t m_bAlignRootMotionWithMoveDirection = 0xA5; // bool
            }
            // Parent: None
            // Field count: 13
            //
            ...
            namespace CTargetWarpUpdateNode {
                constexpr std::ptrdiff_t m_hTargetPositionParameter = 0x6C; // CAnimParamHandle
                constexpr std::ptrdiff_t m_hTargetUpVectorParameter = 0x6E; // CAnimParamHandle
                constexpr std::ptrdiff_t m_hTargetFacePositionParameter = 0x70; // CAnimParamHandle
                constexpr std::ptrdiff_t m_bTargetFacePositionIsWorldSpace = 0x72; // bool
                constexpr std::ptrdiff_t m_bTargetPositionIsWorldSpace = 0x73; // bool
            }
            // Parent: CNmBoolValueNode__CDefinition
            // Field count: 1
            //
