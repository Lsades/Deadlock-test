    ...
    namespace schemas {
        ...
        namespace particles_dll {
            ...
            namespace CBaseRendererSource2 {
                ...
                constexpr std::ptrdiff_t m_flFeatheringDepthMapFilter = 0x26F8; // CParticleCollectionRendererFloatInput
                constexpr std::ptrdiff_t m_flDepthBias = 0x2858; // CParticleCollectionRendererFloatInput
                constexpr std::ptrdiff_t m_nSortMethod = 0x29B8; // ParticleSortingChoiceList_t
                constexpr std::ptrdiff_t m_bBlendFramesSeq0 = 0x29BC; // bool
                constexpr std::ptrdiff_t m_bMaxLuminanceBlendingSequence0 = 0x29BD; // bool
            }
            // Parent: CParticleFunctionOperator
            // Field count: 0
            //
            ...
            namespace C_OP_RenderSprites {
                ...
                constexpr std::ptrdiff_t m_nOrientationType = 0x2D78; // ParticleOrientationChoiceList_t
                constexpr std::ptrdiff_t m_nOrientationControlPoint = 0x2D7C; // int32
                constexpr std::ptrdiff_t m_bUseYawWithNormalAligned = 0x2D80; // bool
