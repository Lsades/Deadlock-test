    ...
    namespace schemas {
        ...
        namespace vphysics2_dll {
            ...
            namespace RnHullDesc_t {
                constexpr std::ptrdiff_t m_Hull = 0x20; // RnHull_t
            }
            // Parent: None
            // Field count: 3
            //
            ...
            namespace RnCapsuleDesc_t {
                constexpr std::ptrdiff_t m_Capsule = 0x20; // RnCapsule_t
            }
            // Parent: RnShapeDesc_t
            // Field count: 1
            //
            ...
            namespace RnSphereDesc_t {
                constexpr std::ptrdiff_t m_Sphere = 0x20; // SphereBase_t<float32>
            }
            // Parent: RnShapeDesc_t
            // Field count: 1
            //
            ...
            namespace RnMeshDesc_t {
                constexpr std::ptrdiff_t m_Mesh = 0x20; // RnMesh_t
            }
            // Parent: None
            // Field count: 106
            //
            ...
            namespace vphysics_save_cphysicsbody_t {
                ...
                constexpr std::ptrdiff_t m_RemovedHitGroups = 0xD8; // CUtlVector<CGlobalSymbol>
            }
            // Parent: FeBoxRigid_t
            // Field count: 2
            //
            ...
            namespace RnShapeDesc_t {
                ...
                constexpr std::ptrdiff_t m_sHitGroupName = 0x18; // CGlobalSymbol
            }
            // Parent: None
            // Field count: 1
            //
